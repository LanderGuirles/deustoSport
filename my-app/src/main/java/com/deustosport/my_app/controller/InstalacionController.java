...
public class InstalacionController {
    ...
    public ResponseEntity<?> listarPistasDeUnaInstalacion(@PathVariable("instalacionId") Long instalacionId) {
        try {
            List<Pista> pistas = pistaService.obtenerPistasPorInstalacionId(instalacionId);
